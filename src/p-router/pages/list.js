  ...
  children: [
    {
      ...
      name: ConstantRouteName.TABLE_LIST,
      component: loadable(() =>
        import(/* webpackChunkName: "table-list" */ '@/p-pages/list/table-list'),
      ),
    },
    {
      path: 'target-list',
      ...
      children: [
        {
          ...
          name: ConstantRouteName.TARGET_LIST_LIST,
          component: loadable(() =>
            import(/* webpackChunkName: "target-list" */ '@/p-pages/list/target-list'),
          ),
        },
        {
          path: 'add',
          ...
          component: loadable(() =>
            import(/* webpackChunkName: "target-list" */ '@/p-pages/list/target-list/add'),
          ),
        },
        {
          path: 'update/:id',
        ...
        },
        {
          ...
          component: loadable(() =>
            import(/* webpackChunkName: "target-list" */ '@/p-pages/list/target-list/detail'),
          ),
        },
      ],
    },
